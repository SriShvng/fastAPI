...
__Directive: GraphQLObjectType = GraphQLObjectType(
    ...
    fields=lambda: {
        ...
        "name": GraphQLField(
            GraphQLNonNull(GraphQLString), resolve=DirectiveResolvers.name,
        ),
        "description": GraphQLField(
            GraphQLString, resolve=DirectiveResolvers.description,
        ),
        "isRepeatable": GraphQLField(
            GraphQLNonNull(GraphQLBoolean), resolve=DirectiveResolvers.is_repeatable,
        ),
...
__Type: GraphQLObjectType = GraphQLObjectType(
    ...
    fields=lambda: {
        ...
        "possibleTypes": GraphQLField(
            GraphQLList(GraphQLNonNull(__Type)), resolve=TypeResolvers.possible_types,
        ),
...
__Field: GraphQLObjectType = GraphQLObjectType(
    ...
    fields=lambda: {
        ...
        "isDeprecated": GraphQLField(
            GraphQLNonNull(GraphQLBoolean), resolve=FieldResolvers.is_deprecated,
        ),
